                        ...
                        <div key={item?._id}>
                            ...
                            <div className={cx('product-info')}>
                                ...
                                <div className={cx('product-info-price')}>
                                    Giá thiết bị :<span className={cx('product-info-price-text')}> {convertPrice(pricesale)}</span>
                                </div>
                                <div className={cx('product-info-amount')}>
                                    {' '}
                                    Số Lượng thiết bị : <span className={cx('product-info-amount-text')}>{item?.amount}</span>
                                </div>
                            </div>
                        </div>
                    );
