...
function Cart() {
    ...
    const handleAddCart = () => {
        if (!order?.orderItemSelected?.length) {
            messages.error('vui lòng chọn thiết bị');
    ...
    return (
        <div className={cx('wrapper')}>
            ...
            <div className={cx('inner')}>
                <div className={cx('container')}>
                    <div className={cx('check-all')}>
                        ...
                        <span className={cx('text-all')}>Chọn tất cả ({order?.orderItems?.length} thiết bị)</span>
            ...
            <ModalComponent forceRender title="Xóa thiết bị" open={isModalOpenUpdateInfo} onCancel={handleCancelUpdate} onOk={handleUpdateInfoUser}>
